...
public class ImageResized {
	...
	public final static String URL_SPRITE = "file:"+ MultiplatformUtility.KERNEL_SEPARATOR + MultiplatformUtility.KERNEL_SEPARATOR + MultiplatformUtility.KERNEL_SEPARATOR + "Users" + MultiplatformUtility.KERNEL_SEPARATOR + "daniel" + MultiplatformUtility.KERNEL_SEPARATOR + "eclipse-workspace" + MultiplatformUtility.KERNEL_SEPARATOR + "PlaneModel" + MultiplatformUtility.KERNEL_SEPARATOR  +"src" + MultiplatformUtility.KERNEL_SEPARATOR + "application.resources" + MultiplatformUtility.KERNEL_SEPARATOR + "Plane.png";
	...
	public ImageResized() {
		...
		proportionImageResized.setRatioScreen(new Ratio(MainPlaneView.SCREEN_WIDTH, MainPlaneView.SCREEN_HEIGHT));
	}
